                    ...
                    <div class=" p-6 ">
                        <div class="row justify-content-between ">
                            <div class="col-md-4 col-12 mb-2 mb-md-0 flex-row">
                                <form method="GET" action="{{ route('product.index') }}" class="d-flex column-gap-3"
                                    role="search">
                                    <input class="form-control" value="{{ $keyword }}" name="keyword" type="search"
                                        placeholder="Search" aria-label="Search">
                                    <button type="submit" class="btn btn-success flex-shrink-0">收尋</button>
                                </form>
                                ...
                                <tbody>
                                    @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#"> <img src="{{ asset($product->img_path) }}" alt=""
